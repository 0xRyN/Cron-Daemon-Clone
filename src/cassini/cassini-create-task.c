...
int create_task(char* REQ_PIPE_PATH, char* RES_PIPE_PATH, uint16_t operation,
                int argc, char* argv[], char* minutes_str, char* hours_str,
                char* daysofweek_str) {
    ...
    if (timing_from_strings(time, minutes_str, hours_str, daysofweek_str) ==
        -1) {
